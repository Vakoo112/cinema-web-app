...
public class SwaggerConfig {
  ...
  public GroupedOpenApi externalApi() {
    return GroupedOpenApi
        ...
        .packagesToScan("notification_service.notification.v1.controller.external")
  ...
  public GroupedOpenApi internalApi() {
    return GroupedOpenApi
        ...
        .packagesToScan("notification_service.notification.v1.controller.internal")
  ...
  public OpenAPI apiInfo() {
    return new OpenAPI()
        .info(new Info()
            ...
            .description("Rest Api For Notification")
            .version("1.0"));
  }
