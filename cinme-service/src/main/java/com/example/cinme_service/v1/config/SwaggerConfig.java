...
public class SwaggerConfig {
  ...
  public GroupedOpenApi externalApi() {
    return GroupedOpenApi
        ...
        .packagesToScan("com.example.cinme_service.v1.controller.external")
  ...
  public GroupedOpenApi internalApi() {
    return GroupedOpenApi
        ...
        .packagesToScan("com.example.cinme_service.v1.controller.internal")
  ...
  public OpenAPI apiInfo() {
    return new OpenAPI()
        .info(new Info()
            .title("Cinema Api")
            .description("Rest Api For Cinema")
            .version("1.0"));
  }
